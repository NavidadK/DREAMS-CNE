...
# DREAMS-CNE
This repository contains the code of the methods DREAMS-CNE and DREAMS-CNE-Decoder presented in "DREAMS: Preserving both Local and Global Structure in Dimensionality Reduction" ([arXiv](https://www.arxiv.org/abs/2508.13747)).
